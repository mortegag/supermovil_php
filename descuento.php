  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Al suscribir a 1 colega chofer recibira : ..."<br><span>2% descuento en nuestros servicios por 2 semanas</span></h4>
      </div>
      <div class="item">
        <h4>"Al suscribir a 2 colegas choferes recibira : ......"<br><span>4% de descuento en nuestros servicios por 4 semanas</span></h4>
      </div>
      <div class="item">
        <h4>"Al suscribir a 3 colegas choferes recibira : ......"<br><span>4% de descuento en nuestros servicios por 6 semanas</span></h4>
      </div>
    </div>

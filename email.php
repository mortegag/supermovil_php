...
<div id="listData" class="list-form-container">
    <?php
        ...
        $connection = imap_open('{imap.gmail.com:993/imap/ssl/novalidate-cert}INBOX', 'sirdesarrollo@gmail.com', 'nopassword') or die('Cannot connect to Gmail: '.print_r(imap_errors())); 
